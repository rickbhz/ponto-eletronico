...
public class LancamentoServiceTest {
	...
	public void setUp() throws Exception {
		...
		//BDDMockito.given(this.lancamentoRepository.findById(Mockito.anyLong())).willReturn(new PageImpl<Lancamento>(new ArrayList<Lancamento>()));
	...
	@Test
	public void testPersisteLancamento ()  {
