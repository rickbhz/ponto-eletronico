package com.cadu.pontoeletronico.api.dtos;
...
public class FuncionarioDto {
	...
	@Length(min=2,max=200,message ="Nome tem de 2 a 200 caracteres")
	...
	@Length(min=2,max=200,message ="Email tem de 2 a 200 caracteres")
