...
import com.cadu.pontoeletronico.api.dtos.LancamentoDto;
...
public class LancamentoController {
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarFuncionarioId(
			@PathVariable("funcionarioId") Long funcionarioId,
			@RequestParam(value = "pag", defaultValue = "0") int pag,
			@RequestParam(value = "ord", defaultValue = "id") String ord,
			@RequestParam(value = "dir", defaultValue = "DESC") String dir) {
		log.info("Buscando lancamentos por id do funcionario. id: {}, pagina {}",funcionarioId,pag);
	...
	public ResponseEntity<Response<String>> remover(
		...
		if (!lancamento.isPresent()) {
			log.info("Erro ao remover lancamento: {}",id);
			response.getErrors().add("Erro ao remover. Lançamento não encontrado para o id "+id);
			return ResponseEntity.badRequest().body(response);				
		}
